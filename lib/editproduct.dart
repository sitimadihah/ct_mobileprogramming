...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    ingredientEditingController.text = widget.product.ingredient;
    caloriesEditingController.text = widget.product.calories;
    selectedType = widget.product.category;
    print(caloriesEditingController.text);
  }
  ...
  updateProduct() {
    ...
    //double calories = double.parse(caloriesEditingController.text);
    ...
    if (_image != null) {
      ...
      http.post(server + "/php/update_product.php", body: {
        "prodid": widget.product.pid,
        "prodname": prnameEditingController.text,
        "qty": qtyEditingController.text,
        "price": price.toStringAsFixed(2),
        "ingredients": ingredientEditingController.text,
        "cal": caloriesEditingController.text,
        "ctgry": categoryEditingController.text,
